...
// Number of lines in the display used.
#define nHD44780_Rows     4
#define nHD44780_Columns 20
...
void HD44780_ClearRow(int jRow);
void HD44780_ClearRowAndPrintStr(int jRow, char *pString);
